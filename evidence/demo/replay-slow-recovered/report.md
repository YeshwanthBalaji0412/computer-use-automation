...
| 17 | automation | step_finished | s3 | duration_ms=5619 |
...
| 22 | automation | step_finished | s4 | duration_ms=5031 |
...
| 27 | automation | step_finished | s5 | duration_ms=5591 |
...
| 32 | automation | step_finished | s6 | duration_ms=5459 |
| 33 | automation | step_started | s7 | read the member's current savings balance |
| 34 | automation | policy_decision | s7 | decision=allow, rule=default |
| 35 | automation | locator_resolved |  | target=the Balance cell in the row where Account = Savings (frame contentFrame), outcome=n |
| 36 | automation | recovery | s7 | recovery=transient-load, attempt=1 |
| 37 | automation | locator_resolved |  | target=the Balance cell in the row where Account = Savings (frame contentFrame), outcome=r |
| 38 | automation | action | s7 | extracted=savingsBalance |
| 39 | automation | step_finished | s7 | duration_ms=5032 |
| 40 | automation | run_finished |  | status=success, duration_ms=27340 |
