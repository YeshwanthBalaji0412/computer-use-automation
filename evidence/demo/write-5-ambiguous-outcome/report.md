# Replay: member.open-subaccount@1.0.0 (escalated)

- run: `rep_1f4488646046` (replay)
- events: 58
...
| 7 | automation | step_finished | s1 | duration_ms=35 |
...
| 32 | automation | step_finished | s6 | duration_ms=5616 |
...
| 42 | automation | step_finished | s8 | duration_ms=5067 |
...
| 47 | automation | step_finished | s9 | duration_ms=5483 |
...
| 52 | automation | step_finished | s10 | duration_ms=5666 |
...
| 57 | automation | escalation_raised | s11 | reason=ambiguous_write_outcome, detail=step s11 (commit the new sub-account) is an irrever |
| 58 | automation | run_finished |  | status=escalated, duration_ms=49986 |
