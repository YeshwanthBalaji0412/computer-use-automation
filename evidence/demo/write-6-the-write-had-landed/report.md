# Replay: member.open-subaccount@1.0.0 (business_outcome)

- run: `rep_c39735156ed1` (replay)
- events: 53
...
| 7 | automation | step_finished | s1 | duration_ms=44 |
...
| 12 | automation | step_finished | s2 | duration_ms=47 |
...
| 17 | automation | step_finished | s3 | duration_ms=5667 |
...
| 27 | automation | step_finished | s5 | duration_ms=5640 |
...
| 32 | automation | step_finished | s6 | duration_ms=5628 |
...
| 52 | automation | business_outcome | s10 | code=DUPLICATE_RECORD |
| 53 | automation | run_finished |  | status=business_outcome, duration_ms=44469 |
